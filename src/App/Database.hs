...
data AuthHandler m = AuthHandler {
...
data AuthorsHandler m = AuthorsHandler {
...
data TagsHandler m = TagsHandler {
...
data CatsHandler m = CatsHandler {
...
data CommentsHandler m = CommentsHandler {
...
data DraftsHandler m = DraftsHandler {
